...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const API = {
        adminInfo: `http://localhost:5058/api/Usuario/ObtenerUsuario?idUsuario=${1}`,
        asesores: `http://localhost:5058/api/Usuario/ObtenerAsesoresPorAdmin?idAdmin=${1}`,
            ...
            <div class="activity-item">
                ...
                <div class="activity-name">
                    ...
                    <div class="activity-name-text">
                        ${asesor.nombre + " " + asesor.primerApellido || ''}
                    </div>
                </div>
